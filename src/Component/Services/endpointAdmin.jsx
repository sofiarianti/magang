...
const endpointsAdmin = {
  users: {
    ...
    loginSuperAdmin: '/api/users/login/superadmin',
  ...
  transaksi: {
    ...
    getByDonatur: (idDonatur) => `/api/transaksi/donatur/${idDonatur}`,
    getByKodeDonatur: (kd_donatur) => `/api/transaksi/by-donatur/${kd_donatur}`,
