...
function ForgotPassword({ onGoToLogin }) {
  ...
  const handleSendOtp = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Gagal mengirim OTP. Pastikan email terdaftar.');
    } finally {
      setIsLoading(false);
    }
  };
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      ...
      setError(err.response?.data?.error || 'Gagal mengubah password. Pastikan OTP benar.');
    } finally {
      setIsLoading(false);
    }
  };
